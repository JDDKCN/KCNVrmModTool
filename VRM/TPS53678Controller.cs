...
{
    public class TPS53678Controller : AbstractVrmController
    {
        public TPS53678Controller(MCP2221Device device) : base(device)
        {
        }
        ...
        public override bool DetectDevice(byte address)
        {
            ...
            if (result != 0 || idData[0] != 1 || idData[1] != 120) // 0x01, 0x78
                return false;
        ...
        public override int SetIccMaxToMaximum(byte address)
        {
            ...
            if (result != 0 || idData[0] != 1 || idData[1] != 120) // 0x01, 0x78
            {
                Console.WriteLine("TPS53678 not found\n");
                return -1;
            }

            Console.WriteLine("TPS53678 found: starting modd\n");
            ...
            if (result != 0)
            {
                Console.WriteLine("TPS53678 modd error\n");
                return -1;
            }

            Console.WriteLine("TPS53678 modd successful\n");
            return 0;
        }
    }
}
